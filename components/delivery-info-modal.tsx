    ...
    >
      ...
      >
        ...
        <div className="relative z-20 overflow-y-auto p-8 md:p-12">
          <span className="font-mono text-xs uppercase tracking-[0.3em] text-[#c9a227]">Logistique</span>
          <h2 className="mb-6 mt-2 text-balance text-4xl font-bold text-white">Livraison & Meet-up</h2>

          {/* Recommandations */}
          <div className="mb-6 rounded-2xl border border-[#c9a227]/30 bg-[#c9a227]/10 p-6">
            <div className="mb-3 flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#c9a227]/20 text-[#c9a227]">
          ...
          <div className="mb-6 rounded-2xl border border-white/10 bg-[#050505]/60 p-6">
            ...
            <ul className="space-y-3 text-sm text-zinc-300">
              <li className="flex items-start gap-3">
                <BadgeEuro className="mt-0.5 h-4 w-4 shrink-0 text-[#c9a227]" aria-hidden="true" />
                <span>
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-[#050505]/60 p-6">
            ...
            <ul className="space-y-3 text-sm text-zinc-300">
              <li className="flex items-start gap-3">
                <ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-[#c9a227]" aria-hidden="true" />
                <span>
                  Mode <strong className="text-white">100% anonyme</strong> : aucune adresse personnelle communiquée, colis déposé en point relais.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Coins className="mt-0.5 h-4 w-4 shrink-0 text-[#c9a227]" aria-hidden="true" />
                <span>
              ...
              <li className="flex items-start gap-3">
                <Info className="mt-0.5 h-4 w-4 shrink-0 text-[#c9a227]" aria-hidden="true" />
                <span>
          ...
          <div className="mt-6 flex items-start gap-3 rounded-2xl border border-white/10 bg-[#050505]/60 p-5 text-sm text-zinc-300">
            <Users className="mt-0.5 h-4 w-4 shrink-0 text-[#c9a227]" aria-hidden="true" />
