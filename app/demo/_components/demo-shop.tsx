    ...
    <>
      ...
      <nav className="sticky top-9 z-50 flex items-center justify-between border-b border-white/10 bg-black/80 px-6 py-4 backdrop-blur-md">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-white">L'Empire des Légendes</span>
        </div>
      ...
      <section className="flex flex-col items-center justify-center px-4 py-24 text-center">
        <p className="mb-3 text-xs uppercase tracking-[0.3em] text-[#c9a227]">Laboratoire Clandestin</p>
        <h1 className="mb-6 text-5xl font-light tracking-tight text-white md:text-7xl">Breaking<span className="font-bold">Bad</span><span className="text-[#c9a227]">33</span></h1>
      ...
      <section id="phares" className="mx-auto max-w-[1200px] scroll-mt-20 px-4 pb-20 pt-10">
        <div className="mb-12 flex items-center gap-4">
          <FlaskConical className="h-8 w-8 text-[#c9a227]" />
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-[#c9a227]">Sélection</p>
          ...
          {phares.map((p) => {
            ...
            return (
              <div
                ...
                className={`group relative flex flex-col items-center overflow-hidden rounded-3xl border border-white/10 bg-[#0a0a0a] p-6 text-center transition-all ${out ? "cursor-not-allowed opacity-50" : "cursor-pointer hover:border-[#c9a227]/50"}`}
              >
                <ProductBadges badges={badges} />
                <div className="relative mb-6 h-40 w-40">
                  <Image src={p.image} alt={p.title} fill className="object-contain" />
                </div>
                {p.symbol && <span className="mb-1 font-mono text-xs uppercase tracking-[0.2em] text-[#c9a227]">{p.symbol}</span>}
      ...
      <section id="concentres" className="mx-auto max-w-[1200px] px-4 py-20">
        <div className="mb-12 flex items-center gap-4">
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.3em] text-[#c9a227]">Spécialités</p>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 p-4 backdrop-blur-sm" onClick={() => setSelected(null)}>
          <div className="relative flex w-full max-w-2xl flex-col overflow-hidden rounded-3xl border border-white/10 bg-[#0a0a0a] md:flex-row" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex w-full flex-col justify-center p-12 md:w-1/2">
              {selected.number && (
                <span className="mb-2 font-mono text-xs uppercase tracking-[0.2em] text-[#c9a227]">Code {selected.number}</span>
              )}
              ...
              <button
                ...
                className="w-full rounded-full bg-[#c9a227] py-4 text-sm font-bold uppercase tracking-widest text-white hover:bg-[#c9a227]/80"
              >
